...
#SBATCH --output=/bigwork/nhkffrei/solver_and_case/RHEO_back/logs/slurm-%A_%a.out
#SBATCH --error=/bigwork/nhkffrei/solver_and_case/RHEO_back/logs/slurm-%A_%a.err
...
CASE_DIR=$BIGWORK/solver_and_case/RHEO_back/run${RUN_ID}
...
cd "$BIGWORK/solver_and_case/RHEO_back" || exit 1
