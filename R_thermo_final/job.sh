#!/bin/bash
#SBATCH --job-name=R_thermo_final
...
#SBATCH --output=/bigwork/nhkffrei/solver_and_case/R_thermo_final/logs/slurm-%A_%a.out
#SBATCH --error=/bigwork/nhkffrei/solver_and_case/R_thermo_final/logs/slurm-%A_%a.err
...
CASE_DIR=$BIGWORK/solver_and_case/R_thermo_final/run${RUN_ID}
...
cd "$BIGWORK/solver_and_case/R_thermo_final" || exit 1
