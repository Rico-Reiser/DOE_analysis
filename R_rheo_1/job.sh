...
#SBATCH --output=/bigwork/nhkffrei/solver_and_case/R_rheo_1/logs/slurm-%A_%a.out
#SBATCH --error=/bigwork/nhkffrei/solver_and_case/R_rheo_1/logs/slurm-%A_%a.err
...
CASE_DIR=$BIGWORK/solver_and_case/R_rheo_1/run${RUN_ID}
...
cd "$BIGWORK/solver_and_case/R_rheo_1" || exit 1
