#!/bin/bash
#SBATCH --job-name=alphaPotential
...
#SBATCH --output=/bigwork/nhkffrei/solver_and_case/alphaPotential/logs/slurm-%A_%a.out
#SBATCH --error=/bigwork/nhkffrei/solver_and_case/alphaPotential/logs/slurm-%A_%a.err
...
CASE_DIR=$BIGWORK/solver_and_case/alphaPotential/run${RUN_ID}
...
cd "$BIGWORK/solver_and_case/alphaPotential" || exit 1
