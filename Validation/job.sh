#!/bin/bash
#SBATCH --job-name=freeze_validation
...
#SBATCH --output=/bigwork/nhkffrei/solver_and_case/Validation/logs/slurm-%A_%a.out
#SBATCH --error=/bigwork/nhkffrei/solver_and_case/Validation/logs/slurm-%A_%a.err
...
CASE_DIR=$BIGWORK/solver_and_case/Validation/run${RUN_ID}
...
cd "$BIGWORK/solver_and_case/Validation" || exit 1
