...
#SBATCH --output=/bigwork/nhkffrei/solver_and_case/End_run/logs/slurm-%A_%a.out
#SBATCH --error=/bigwork/nhkffrei/solver_and_case/End_run/logs/slurm-%A_%a.err
...
CASE_DIR=$BIGWORK/solver_and_case/End_run/run${RUN_ID}
...
cd "$BIGWORK/solver_and_case/End_run" || exit 1
